...
TIP: Expect this playbook to take a little time to complete. When it finishes, there will be a popup about an application running on port 8089, which can be safely closed.
