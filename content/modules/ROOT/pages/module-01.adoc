...
TIP: If you don't see a "Terminal" option at the top, it may be cut off due to a small window. You can access the Terminal menu by clicking the 3 dots `...` to the right.
